  ...
  return (
    <header className="sticky top-0 z-20 bg-black/90 border-b border-zinc-800/90 backdrop-blur-xl px-4 sm:px-8 py-3.5 flex items-center justify-between">
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Notification Button */}
        <button className="p-2 rounded-xl bg-zinc-950 border border-zinc-800 text-zinc-400 hover:text-white transition-colors cursor-pointer" title="Notifications">
