    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-4 sm:gap-5 min-w-0">
          <div className="w-18 h-18 sm:w-20 sm:h-20 rounded-2xl bg-[#f4efe6] border border-[#e2dacd] shadow-2xs flex items-center justify-center shrink-0 overflow-hidden group-hover:scale-105 transition-transform p-1">
            <StatusAnimationRenderer
          ...
          <div className="space-y-0.5 min-w-0">
            ...
            <div className="text-base sm:text-xl font-black text-zinc-900 tracking-tight truncate">
              {statusData.label}
            </div>
          </div>
        </div>
        ...
        {isOwnProfile ? (
          <button
            ...
            className="px-3.5 py-2 rounded-xl bg-[#f4efe6] group-hover:bg-zinc-900 group-hover:text-white border border-[#e2dacd] text-zinc-800 text-xs font-bold transition-all shadow-2xs cursor-pointer flex items-center gap-1.5 shrink-0"
            title="Change status"
          >
            <svg
          ...
          <span className="px-2.5 py-1 rounded-lg bg-[#f4efe6] border border-[#e2dacd] text-zinc-600 text-[11px] font-bold shrink-0">
            Active
          </span>
        )}
      </div>
